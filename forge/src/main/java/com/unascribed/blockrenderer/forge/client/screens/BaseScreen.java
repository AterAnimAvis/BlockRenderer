...
public abstract class BaseScreen extends Screen {
    ...
    protected void init() {
        ...
        addButton(new Button(width / 2 - 100, height / 6 + 120, 98, 20, translate("gui.cancel"), button -> minecraft.displayGuiScreen(old)));
    ...
    public void render(MatrixStack stack, int mouseX, int mouseY, float partialTicks) {
        ...
        drawCenteredString(stack, minecraft.fontRenderer, translate("block_renderer.gui.noWorld"), width / 2, height / 6 + 30, 0xFF5555);
    }
