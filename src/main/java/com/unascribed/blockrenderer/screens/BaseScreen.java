...
import com.unascribed.blockrenderer.mixin.accessor.IDisplayPrefix;
...
public abstract class BaseScreen extends Screen {
    ...
    public Text getSliderDisplay(GameOptions settings, DoubleOption option) {
        int px = round(size);
        return ((IDisplayPrefix) option).getDisplayPrefix().copy().append(": " + px + "x" + px);
    }
